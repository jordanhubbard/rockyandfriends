...
MC=${MC_BIN:-mc}
QUEUE_FILE="${OPENCLAW_WORKSPACE:-~/.openclaw/workspace}/workqueue/queue.json"
AZURE_SAS="${AZURE_BLOB_SAS_URL:-}"
...
python3 "${OPENCLAW_WORKSPACE:-~/.openclaw/workspace}/workqueue/scripts/gen-dashboard.py" \
