...
const SERVICES_CATALOG = [
  { id: 'rcc-dashboard',    name: 'CCC Dashboard',      url: 'http://146.190.134.110:8789/projects',  desc: 'Agent work queue + project tracker',       host: 'do-host1' },
...
# rcc-vllm-tunnel autostart (added by CCC onboard)
...
export function startServer(port = PORT) {
  ...
  server.listen(port, '0.0.0.0', () => {
    console.log(`[rcc-api] 🐿️ CCC API running on http://0.0.0.0:${port}`);
