...
// Single source of truth. Both clawchat.rs and future component modules import from here.
// Wire format matches clawchat-server (Rust/Axum) models.rs exactly.

use serde::{Deserialize, Serialize};

// ─── Message ─────────────────────────────────────────────────────────────────

/// Wire format from clawchat-server's `MessageWire` struct.
...
/// Client → Server frames (matching clawchat-server's `ClientFrame`)
#[allow(dead_code)]
...
/// Server → Client frames (matching clawchat-server's `ServerFrame`)
